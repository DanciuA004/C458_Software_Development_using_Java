...
INSERT INTO TaskStatus (TaskStatusId, `Name`, IsResolved)
VALUES (1, 'Parked', 0),
       (2, 'In Progress', 0),
...
INSERT INTO Project(ProjectId, `Name`, Summary, DueDate, IsActive)
VALUES ('payroll', 'GameIt Payroll', 'Employee payroll, bonuses, and PTO tracking. Mission critical.', null, 1),
       ('hr', 'GameIt Human Resource Intranet', 'SharePoint intranet and document storage', '2013-08-12', 0),
       ('hr-v2', 'GameIt HR Intranet V2', 'Improved usability, simpler interface, a better intranet experience...',
        null, 1),
       ('accounts-receivable', 'GameIt Accounts Receivable',
        'Internal accounting application. Requires integration with accounts receivable project.', '2020-12-31', 1),
       ...
       ('game-breakout', 'Middle School Breakout',
        'Like whack-a-mole, but with acne. Still a hit after all these years.', '2005-05-20', 1),
       ('game-breakout-mobile', 'Middle School Breakout Mobile', 'iOS and Android rewrite of Middle School Breakout',
        '2018-11-05', 1),
       ('game-sisyphus', 'I Am Sisyphus',
        'An open world, open rules, player-directed game. You can''t win, or maybe you can, we''ll never truly know.',
        '2017-06-12', 1),
       ('game-cooker', 'CookerMaker', 'Time management cooking game. You pick the cuisine.', '2019-01-12', 1),
       ('game-cheese', 'Don''t Eat The Cheese!', 'Based on a true story about an angry tummy in Prague.', '2010-01-19',
        0),
       ('game-stormchaser', 'Stormchaser', 'Study weather in the lab and... In the eye of the storm!', '2015-06-01', 1),
       ('game-patience', 'The Patience Game',
        'Described by Rock, Scissors, Shotgun as "quiet", "fixed", and "prosaic".', '2018-02-25', 1),
       ...
       ('enterprise-crm', 'GameIt Enterprise', 'GameIt''s one and only foray into "enterprise" software. Retired.',
        '2014-08-01', 0),
       ('game-diva', 'Diva Diva Diva',
        'Out-sing and out-dance your opponents in this kinetic PvP game. (Requires spatial controllers.)', '2017-11-10',
        1),
       ...
       ('game-economy', 'It''s the Economy, Stupid!',
        'Gather resources, build stuff with them, trade with your neighbors. It''s about who you know, not what you know.',
        '2018-11-25', 1),
       ('game-midge3', 'Midge III', 'Live as Midge in VR and AR.', '2020-12-31', 1);

INSERT INTO Worker (WorkerId, FirstName, LastName, EmailAddress)
VALUES (1, 'Inez', 'Fanthome', 'ifanthome0@latimes.com'),
...
INSERT INTO Task (TaskId, Title, Details, DueDate, EstimatedHours, ProjectId, WorkerId, TaskTypeId, TaskStatusId,
                  ParentTaskId)
VALUES (1, 'Log in', '', '2007-02-19', 22.00, 'payroll', 60, 1, 2, null),
       ...
       (230, 'Profile vehicle, clothing, and building assets', '', '2011-10-18', 3.75, 'game-breakout-mobile', 7, 2, 7,
        226),
       ...
       (255, 'Transition between welcome and Level 1 still glitchy', '', '2013-08-09', 5.75, 'game-cooker', 63, 3, 3,
        null),
       ...
       (378, 'Develop Midge-is-dreaming sequence and healing/level-up', '', '2018-01-18', 22.50, 'game-midge', 1, 1, 5,
        null),
       ...
       (426, 'Cotroni family is too powerful. Makes for unbalanced gameplay.', '', '2018-01-06', 6.25, 'game-mafia', 88,
        3, 4, null),
       ...
       (452, 'Develop "Did smart phones kill letter writing?"', '', '2012-08-25', 23.75, 'game-postmodern', 74, 1, 5,
        null),
